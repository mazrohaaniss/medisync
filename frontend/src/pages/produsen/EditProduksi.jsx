// frontend/src/pages/produsen/EditProduksi.jsx
...
const EditProduksi = () => {
  ...
  // Fetch data produksi berdasarkan ID saat komponen dimuat
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          jumlah: data.jumlah,
          tanggalProduksi: new Date(data.tanggal_produksi),
          tanggalKadaluarsa: new Date(data.tanggal_kadaluarsa),
          prioritas: data.prioritas,
          status: data.status,
          komposisiObat: data.komposisi_obat || '',
          dokumenBpom: null, // File tidak diambil ulang, hanya untuk upload baru
        });
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess('Data produksi berhasil diperbarui!');
      setTimeout(() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="mt-1 block w-full block w-full border rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-[#18A375] h-32"
                  />
                </div>
                <div className="md:col-span-2">
                    ...
                    <div className="space-y-1 text-center">
                      ...
                      <div className="flex text-sm text-gray-600">
                        <label
                          ...
                          className="relative cursor-pointer rounded-md font-medium text-[#18A375] hover:text-[#158c63]"
                        >
                      ...
                      {formData.dokumenBpom && (
                        <p className="text-sm text-gray-600 mt-2">File baru: {formData.dokumenBpom.name}</p>
                      )}
                    </div>
                  </div>
                </div>
